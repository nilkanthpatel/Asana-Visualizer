            ...
            */
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        if (entry.name.length>1) {
                            ...
                            entries.push('<div class="row name notHeader row' + i + ' fn-wide" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize() + '">');
            ...
            navigation: function (element) {
                ...
                if (settings.navigate === "scroll") {
                    ganttNavigate = $('<div>')
                        .append('<img src="./img/today.png" />')
                        .append('<img src="./img/info.png" onclick="toggleMoreInformation()" />')
                        .append($('<img src="./img/out.png" />')
                            .html('&#43;')
                            .click(function () {
                                core.zoomInOut(element, 1);
                                if (window.currentScale < 2) { window.currentScale = window.currentScale+1; }
                            }))
                        .append('<div id="ganttNavScroll"><div id="ganttNavScrollBar"></div></div>')
                        .append($('<img src="./img/in.png" />')
                            .html('&#45;')
                            .click(function () {
                                core.zoomInOut(element, -1);
                                if (window.currentScale > 0) { window.currentScale = window.currentScale-1; }
                            }))
                        .append('<img src="./img/collapse.png" />')
                        .append('<img src="./img/expand.png" />');
